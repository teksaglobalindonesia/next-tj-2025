export default function Achievement() {
  return (
    <section className="flex flex-row items-center justify-between bg-neutral-silver py-[48px] px-[104px]">
      <div className="flex flex-col w-[540px] h-[120px] gap-[8px] px-[24px]">
        ...
        <p className="w-[400px] h-[24px] text-[16px] mt-11 font-inter text-gray-900">
