  ...
  return (
    <section className="flex flex-row items-center justify-between py-[40px] px-[104px]">
        ...
        <div className="flex flex-col gap-[16px] w-[661px] h-[268px] mb-[12px]">
            ...
            <p className="font-inter text-neutral-dgrey text-[14px] w-[601px] h-[20px] py-[1px]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.
            </p>

        <button className="w-[151px] h-[52px] py-[14px] px-[32px] bg-green-600 text-white rounded-md hover:bg-green-700 transition mt-16 gap-[10px]">
          Learn More
        </button>
        </div>
    </section>
