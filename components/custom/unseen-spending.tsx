export default function Spending() {
  return (
    <section className="flex flex-col md:flex-row items-center md:justify-between py-10 px-4 md:px-[104px]">
      <img src="/spending.png" alt="" className="w-full sm:w-[350px] md:w-[442px] h-auto md:h-[433px] mb-6 md:mb-0"/>

      <div className="flex flex-col gap-[16px] w-full md:w-[661px] h-auto md:h-[268px] mb-[12px]">
        <h2 className="text-[36px] md:text-[36px] font-inter font-semibold text-neutral-dgrey leading-tight w-full md:w-[600px] h-auto md:h-[88px]">
          The unseen of spending three years at Pixelgrade
        </h2>
        <p className="font-inter text-neutral-grey text-[14px] w-full md:w-[601px] h-auto md:h-[80px]">
