export default function Tutorial() {
    return (
       <section className="flex flex-row justify-between items-center px-[104px] py-[40px]">
           ...
           <button className="w-[151px] h-[52px] py-[14px] px-[32px] bg-brand-primary text-white rounded-md gap-[10px] transition-all duration-300 hover:bg-shade-2 hover:scale-105">
             Learn More
           </button>
